...
salmon index -p 22 -t CE_gentrome.fa -i EISA_index --decoys decoys.txt -k 17
...
#Starved L1 GROseq
#faGROseq_StarvedL1_1=${data}/Kruezi2013/GSM1056282_GRO-seq_N2_StarvedL1/SRR639131.fastq.gz
#faGROseq_StarvedL1_2=${data}/Kruezi2013/GSM1056282_GRO-seq_N2_StarvedL1/SRR639132.fastq.gz
...
#Starved L1 GROseq
#salmon quant -i EISA_index -l A -r ${faGROseq_StarvedL1_1} --validateMappings -p 22 -o salmon_out/GROseq_StarvedL1_1 --seqBias --gcBias
#salmon quant -i EISA_index -l A -r ${faGROseq_StarvedL1_2} --validateMappings -p 22 -o salmon_out/GROseq_StarvedL1_2 --seqBias --gcBias
