...
#CTRL 1 GROseq
#salmon quant -i EISA_index -l A -r ${faN2_GROseq_ctrl_1} --validateMappings -p 24 -o salmon_out/N2_GROseq_ctrl_1 --seqBias --gcBias
#salmon quant -i EISA_index -l A -r ${faN2_GROseq_ctrl_2} --validateMappings -p 24 -o salmon_out/N2_GROseq_ctrl_2 --seqBias --gcBias

#CTRL RNAi 2 GROseq
#salmon quant -i EISA_index -l A -r ${faN2_GROseq_ctrlRNAi_1} --validateMappings -p 24 -o salmon_out/N2_GROseq_ctrlRNAi_1 --seqBias --gcBias
#salmon quant -i EISA_index -l A -r ${faN2_GROseq_ctrlRNAi_2} --validateMappings -p 24 -o salmon_out/N2_GROseq_ctrlRNAi_2 --seqBias --gcBias

#SDC2_RNAi GROseq
#salmon quant -i EISA_index -l A -r ${faGROseq_sdc2_1} --validateMappings -p 24 -o salmon_out/GROseq_sdc2_1 --seqBias --gcBias
#salmon quant -i EISA_index -l A -r ${faGROseq_sdc2_2} --validateMappings -p 24 -o salmon_out/GROseq_sdc2_2 --seqBias --gcBias

#CTRL RNAseq
#salmon quant -i EISA_index -l A -r ${faN2_RNAseq_ctrl_1} --validateMappings -p 24 -o salmon_out/N2_RNAseq_ctrl_1 --seqBias --gcBias
#salmon quant -i EISA_index -l A -r ${faN2_RNAseq_ctrl_2} --validateMappings -p 24 -o salmon_out/N2_RNAseq_ctrl_2 --seqBias --gcBias
#salmon quant -i EISA_index -l A -r ${faN2_RNAseq_ctrl_3} --validateMappings -p 24 -o salmon_out/N2_RNAseq_ctrl_3 --seqBias --gcBias
#salmon quant -i EISA_index -l A -r ${faN2_RNAseq_ctrl_4} --validateMappings -p 24 -o salmon_out/N2_RNAseq_ctrl_4 --seqBias --gcBias

#SDC2_RNAi RNAseq
#salmon quant -i EISA_index -l A -r ${faRNAseq_sdc2_1} --validateMappings -p 24 -o salmon_out/RNAseq_sdc2_1 --seqBias --gcBias
#salmon quant -i EISA_index -l A -r ${faRNAseq_sdc2_2} --validateMappings -p 24 -o salmon_out/RNAseq_sdc2_2 --seqBias --gcBias
#salmon quant -i EISA_index -l A -r ${faRNAseq_sdc2_3} --validateMappings -p 24 -o salmon_out/RNAseq_sdc2_3 --seqBias --gcBias
