...
fa366b2_2=/scratch/aannan/rnaseq/data/366b2/366B2_L2_R1_001_6eYI0PJPBw8Q.fastq.gz
...
salmon index -p 30 -t CE_gentrome.fa -i EISA_index --decoys decoys.txt -k 17
#the k size selected here will act as the minimum acceptable length for a valid match.

salmon quant -i EISA_index -l A -r ${fa366b1_1} ${fa366b1_2} --validateMappings -p 30 -o salmon_out/366b1 --seqBias --gcBias  
salmon quant -i EISA_index -l A -r ${fa382b1_1} ${fa382b1_2} --validateMappings -p 30 -o salmon_out/382b1 --seqBias --gcBias 

salmon quant -i EISA_index -l A -r ${fa366b2_1} ${fa366b2_2} --validateMappings -p 30 -o salmon_out/366b2 --seqBias --gcBias  
salmon quant -i EISA_index -l A -r ${fa382b2_1} ${fa382b2_2} --validateMappings -p 30 -o salmon_out/382b2 --seqBias --gcBias  

salmon quant -i EISA_index -l A -r ${fa366b3_1} ${fa366b3_2} --validateMappings -p 30 -o salmon_out/366b3 --seqBias --gcBias  
salmon quant -i EISA_index -l A -r ${fa382b3_1} ${fa382b3_2} --validateMappings -p 30 -o salmon_out/382b3 --seqBias --gcBias  

salmon quant -i EISA_index -l A -r ${fa366b4_1} ${fa366b4_2} --validateMappings -p 30 -o salmon_out/366b4 --seqBias --gcBias  
salmon quant -i EISA_index -l A -r ${fa382b4_1} ${fa382b4_2} --validateMappings -p 30 -o salmon_out/382b4 --seqBias --gcBias  
