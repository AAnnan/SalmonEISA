...
grep '>intron[0-9]\+' CE_introns_seq.fa | sed 's/>//g' | sed 's/Gene://g' > gene_gen_list.txt
...
paste order_WBGenes_GE NumReads_gen_366b1.sf NumReads_gen_366b2.sf NumReads_gen_366b3.sf NumReads_gen_366b4.sf NumReads_gen_382b1.sf NumReads_gen_382b2.sf NumReads_gen_382b3.sf NumReads_gen_382b4.sf > rawcounts_intron.txt
